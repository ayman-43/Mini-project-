  ...
  const features = [
    {
      ...
      background: (
        <div className="absolute inset-0">
          <img
            src="/images/symptom_analysis.png"
            alt="Symptom Analysis"
            className="h-full w-full object-cover opacity-100 transition-transform duration-300 group-hover:scale-105"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-blue-50/30 to-indigo-50/30 dark:from-blue-900/30 dark:to-indigo-900/30" />
        </div>
      ),
    },
    {
      ...
      background: (
        <div className="absolute inset-0">
          <img
            src="/images/drug_interactions.png"
            alt="Drug Interactions"
            className="h-full w-full object-cover opacity-100 transition-transform duration-300 group-hover:scale-105"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-blue-50/30 to-cyan-50/30 dark:from-blue-900/30 dark:to-cyan-900/30" />
        </div>
      ),
    },
    {
      ...
      background: (
        <div className="absolute inset-0">
          <img
            src="/images/medical_terms.png"
            alt="Medical Terms"
            className="h-full w-full object-cover opacity-100 transition-transform duration-300 group-hover:scale-105"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-indigo-50/30 to-blue-50/30 dark:from-indigo-900/30 dark:to-blue-900/30" />
        </div>
      ),
    },
    {
      ...
      background: (
        <div className="absolute inset-0">
          <img
            src="/images/medical_image_analyzer.png"
            alt="Medical Image Analyzer"
            className="h-full w-full object-cover opacity-100 transition-transform duration-300 group-hover:scale-105"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-purple-50/30 to-pink-50/30 dark:from-purple-900/30 dark:to-pink-900/30" />
        </div>
      ),
    },
    {
      ...
      background: (
        <div className="absolute inset-0">
          <img
            src="/images/medicine_analyzer.png"
            alt="Medicine Analyzer"
            className="h-full w-full object-cover opacity-100 transition-transform duration-300 group-hover:scale-105"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-green-50/30 to-emerald-50/30 dark:from-green-900/30 dark:to-emerald-900/30" />
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      background: (
        <div className="absolute inset-0">
          <img
            src="/images/policy_query.png"
            alt="Policy Query Assistant"
            className="h-full w-full object-cover opacity-100 transition-transform duration-300 group-hover:scale-105"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-cyan-50/30 to-blue-50/30 dark:from-cyan-900/30 dark:to-blue-900/30" />
        </div>
      ),
    },
    {
      ...
      background: (
        <div className="absolute inset-0">
          <img
            src="/images/healthcare_chat.png"
            alt="Healthcare Chat"
            className="h-full w-full object-cover opacity-100 transition-transform duration-300 group-hover:scale-105"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-indigo-50/30 to-purple-50/30 dark:from-indigo-900/30 dark:to-purple-900/30" />
        </div>
      ),
    },
  ];
    ...
    <div className="w-full animate-fadeIn">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 to-white dark:from-gray-900 dark:to-gray-900 py-16 sm:py-24">
        ...
        <div
          ...
          data-us-project="po1qAEulJiYSta31bl4d"
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-blue-50/30 to-white/40 dark:from-gray-900/30 dark:to-gray-900/40" />
        </div>
